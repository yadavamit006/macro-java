...
public class CountDownLatchExample {
    public static void main(String[] args) {
        ...
        new Thread(new Employee(countDownLatch, "Emp 1")).start();
        new Thread(new Employee(countDownLatch, "Emp 2")).start();
        new Thread(new Employee(countDownLatch, "Emp 3")).start();
        try {
